#ifndef CD_CORE_IMGUI_COMPONENTS_GUI_BUTTON_H
#define CD_CORE_IMGUI_COMPONENTS_GUI_BUTTON_H
...
public:
    ...
    void SetColors(Color base, Color hover, Color pressed, Color text)
    {
        m_baseColor = base;
        m_hoverColor = hover;
...
#endif // CD_CORE_IMGUI_COMPONENTS_GUI_BUTTON_H
