...
// Draw skybox model centered at origin (legacy behavior)
...
// Draw skybox model centered at provided position so the skybox follows the camera
inline void DrawSkyboxModelAtPosition(Skyboxlib* skybox, Vector3 position) {
    rlDisableBackfaceCulling();
    rlDisableDepthMask();
    DrawModel(skybox->modelbox, position, 1.0f, WHITE);
    rlEnableBackfaceCulling();
    rlEnableDepthMask();
}

