...
namespace MapObjectConverterEditor
{
    ...
    JsonSerializableObject MapObjectToJsonSerializableObject(const MapObject& obj)
    {
        ...
        case 2: // Cylinder
            ...
            jsonObj.radiusH = (obj.GetHorizontalRadius() > 0.0f) ? obj.GetHorizontalRadius() : obj.GetScale().x;
            jsonObj.radiusV = (obj.GetVerticalRadius() > 0.0f) ? obj.GetVerticalRadius() : obj.GetScale().y;
            break;
        case 3: // Plane
    ...
    MapObjectData MapObjectToMapObjectData(const MapObject& obj)
    {
        ...
        case 1: // Sphere
            ...
            break;
        case 2: // Cylinder
            data.radius = (obj.GetHorizontalRadius() > 0.0f) ? obj.GetHorizontalRadius() : obj.GetScale().x;
