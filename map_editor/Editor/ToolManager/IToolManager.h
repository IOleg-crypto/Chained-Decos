...
public:
    ...
    virtual bool ExecutePendingAction(Editor &editor) = 0;
    virtual void SetSelectedModel(const std::string &modelName) = 0;
    virtual const std::string &GetSelectedModel() const = 0;
    virtual void HandleToolInput(bool mousePressed, const Ray &ray, Editor &editor) = 0;
    virtual void UpdateTool(const Ray &ray, Editor &editor) = 0;
