...
produces three files in the output directory:
  ...
  - script_glue_generated_reg.cpp    (AddInternalCall registration)
...
def main():
    ...
    if not all_properties:
        ...
        (out_dir / "script_glue_generated.cpp").write_text(
            "// <auto-generated/> — no native properties found\n", encoding="utf-8")
        (out_dir / "script_glue_generated_reg.cpp").write_text(
            "// <auto-generated/> — no native properties found\n", encoding="utf-8")
        return
    ...
    (out_dir / "script_glue_generated_reg.cpp").write_text(reg, encoding="utf-8")
    ...
    print(f"  -> {out_dir / 'script_glue_generated_reg.cpp'}")
