...
#include "engine/scene/ecs/components/camera_component.h"
...
void EditorLayer::OnAttach()
{
    ...
    // Initialize UI-Independent Logic
...
void EditorLayer::InitServices()
{
    ProjectManager::Init();
    SelectionManager::Init();
    EditorState::Init();
    SceneSimulationManager::Init();
}

void EditorLayer::OnDetach()
{
    CD_INFO("EditorLayer detached");
    SceneSimulationManager::Shutdown();
...
{
    m_PanelManager->AddPanel<HierarchyPanel>("Hierarchy");
    m_PanelManager->AddPanel<InspectorPanel>("Inspector");
    m_PanelManager->AddPanel<ViewportPanel>("Viewport");
    m_PanelManager->AddPanel<ToolbarPanel>("Toolbar");
    m_PanelManager->AddPanel<ContentBrowserPanel>("Content Browser");
    m_PanelManager->AddPanel<ConsolePanel>("Console");
    m_PanelManager->AddPanel<ProjectBrowserPanel>("Project Browser");
    m_PanelManager->AddPanel<MenuBarPanel>("MenuBar");
}
