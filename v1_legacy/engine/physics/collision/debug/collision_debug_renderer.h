#ifndef CD_COMPONENTS_PHYSICS_COLLISION_DEBUG_COLLISION_DEBUG_RENDERER_H
#define CD_COMPONENTS_PHYSICS_COLLISION_DEBUG_COLLISION_DEBUG_RENDERER_H

#include "../colsystem/collision_system.h"
#include <raylib.h>
#include <vector>
