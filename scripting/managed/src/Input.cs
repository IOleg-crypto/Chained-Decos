...
namespace Chained
{
    public static class Input
    {
        ...
        public static unsafe bool IsKeyDown(Key keyCode) => Input_IsKeyDown_Ptr != null && Input_IsKeyDown_Ptr((int)keyCode);
        public static unsafe bool IsKeyPressed(Key keyCode) => Input_IsKeyPressed_Ptr != null && Input_IsKeyPressed_Ptr((int)keyCode);
        public static unsafe bool IsKeyReleased(Key keyCode) => Input_IsKeyReleased_Ptr != null && Input_IsKeyReleased_Ptr((int)keyCode);

        public static unsafe bool IsMouseButtonDown(MouseButton button) => Input_IsMouseButtonDown_Ptr != null && Input_IsMouseButtonDown_Ptr((int)button);
        public static unsafe bool IsMouseButtonPressed(MouseButton button) => Input_IsMouseButtonPressed_Ptr != null && Input_IsMouseButtonPressed_Ptr((int)button);
