...
CH_SCRIPT_FUNC const char16_t* ButtonControl_GetLabel(uint64_t entityID);
CH_SCRIPT_FUNC void ButtonControl_SetLabel(uint64_t entityID, const char16_t* label);
...
CH_SCRIPT_FUNC const char16_t* LabelControl_GetText(uint64_t entityID);
CH_SCRIPT_FUNC void LabelControl_SetText(uint64_t entityID, const char16_t* text);

CH_SCRIPT_FUNC const char16_t* SliderControl_GetLabel(uint64_t entityID);
CH_SCRIPT_FUNC void SliderControl_SetLabel(uint64_t entityID, const char16_t* label);
...
CH_SCRIPT_FUNC const char16_t* ProgressBarControl_GetOverlayText(uint64_t entityID);
CH_SCRIPT_FUNC void ProgressBarControl_SetOverlayText(uint64_t entityID, const char16_t* text);
...
CH_SCRIPT_FUNC const char16_t* WidgetControl_GetTextColor(uint64_t entityID);
