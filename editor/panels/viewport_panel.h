...
{
public:
    ViewportPanel(EditorSceneActions *sceneActions, EditorProjectActions *projectActions,
                  SelectionManager *selection, SceneSimulationManager *simulation,
                  EditorCamera *camera, EditorEntityFactory *factory, CommandHistory *history,
                  Tool *activeTool);
