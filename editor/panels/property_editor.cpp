                                           ...
                                           std::function<void(Entity)> drawUI)
{
    ...
    auto& metadata = ComponentRegistry::Exists(typeId) ? ComponentRegistry::GetMetadataMutable(typeId)
                                                       : ([&]() -> ComponentMetadata& {
    ...
    RegisterCustom<UIControlComponent>(
        ...
        [](UIControlComponent& comp, Entity entity) {
            ...
            ui.Header("Text Style");
            {
                ...
                auto fontNames =
                    widgetRenderer ? widgetRenderer->GetFontRegistry().GetKnownFontNames() : std::vector<std::string>{};
