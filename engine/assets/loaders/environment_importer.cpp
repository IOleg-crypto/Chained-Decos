...
{
    // metadata.FilePath is already resolved to an absolute path by AssetManager::ImportAsset.
    // Do NOT prepend AssetDirectory here — that would create a double-path bug.
