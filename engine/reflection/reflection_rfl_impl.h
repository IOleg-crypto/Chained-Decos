#ifndef CH_REFLECTION_RFL_IMPL_H
#define CH_REFLECTION_RFL_IMPL_H
...
namespace Chained
{
	...
	template <typename T, typename T_Archive> void ReflectFromRfl(T& component, Chained::Properties<T_Archive>& props)
	{
		...
		view.apply([&](auto field) {
			...
			if (meta.Hidden && props.GetMode() == ReflectionMode::UI)
			{
				return;
			}
...
#endif // CH_REFLECTION_RFL_IMPL_H
