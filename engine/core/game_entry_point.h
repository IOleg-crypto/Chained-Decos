...
typedef void (*CH_RegisterScriptCallback)(void* userData,         // opaque pointer (ScriptRegistry*)
                                          const char* scriptName, // plain C string - ABI safe
                                          CH_InstantiateFn instantiate, CH_DestroyFn destroy);
