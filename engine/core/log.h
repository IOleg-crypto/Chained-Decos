...
{
public:
    static void SetLogLevel(LogLevel level) { s_LogLevel = level; ::SetTraceLogLevel((int)level); }
...
// Core logging macros
#define CH_CORE_TRACE(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogTrace) ::CHEngine::Log::CoreTrace(__VA_ARGS__)
#define CH_CORE_INFO(...)  if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogInfo) ::CHEngine::Log::CoreInfo(__VA_ARGS__)
#define CH_CORE_WARN(...)  if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogWarning) ::CHEngine::Log::CoreWarn(__VA_ARGS__)
#define CH_CORE_ERROR(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogError) ::CHEngine::Log::CoreError(__VA_ARGS__)
#define CH_CORE_FATAL(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogFatal) ::CHEngine::Log::CoreFatal(__VA_ARGS__)

// Client logging macros
#define CH_TRACE(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogTrace) ::CHEngine::Log::ClientTrace(__VA_ARGS__)
#define CH_INFO(...)  if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogInfo) ::CHEngine::Log::ClientInfo(__VA_ARGS__)
#define CH_WARN(...)  if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogWarning) ::CHEngine::Log::ClientWarn(__VA_ARGS__)
#define CH_ERROR(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogError) ::CHEngine::Log::ClientError(__VA_ARGS__)
#define CH_FATAL(...) if (::CHEngine::Log::GetLogLevel() <= ::CHEngine::LogLevel::LogFatal) ::CHEngine::Log::ClientFatal(__VA_ARGS__)
