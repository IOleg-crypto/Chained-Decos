...
namespace CHEngine
{
    ...
    void PhysicsSystem::OnInit() { Physics::Init(); }
    void PhysicsSystem::OnUpdate(Timestep ts) {}
    void PhysicsSystem::OnShutdown() { Physics::Shutdown(); }
    ...
    {
        // NO-OP: Static Physics works directly on ECS components.
    }
