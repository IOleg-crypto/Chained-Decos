#ifndef CH_GLFW_INPUT_MAPPER_H
#define CH_GLFW_INPUT_MAPPER_H
    ...
    public:
        static KeyCode MapKey(int glfwKey)
        {
            switch (glfwKey)
            {
                ...
                case GLFW_KEY_APOSTROPHE: return KeyCode::Null; // Add mapping if needed
                case GLFW_KEY_COMMA: return KeyCode::Null;
                case GLFW_KEY_MINUS: return KeyCode::Null;
                case GLFW_KEY_PERIOD: return KeyCode::Null;
                case GLFW_KEY_SLASH: return KeyCode::Null;
                ...
                case GLFW_KEY_SEMICOLON: return KeyCode::Null;
                case GLFW_KEY_EQUAL: return KeyCode::Null;
                ...
                case GLFW_KEY_LEFT_BRACKET: return KeyCode::Null;
                case GLFW_KEY_BACKSLASH: return KeyCode::Null;
                case GLFW_KEY_RIGHT_BRACKET: return KeyCode::Null;
                case GLFW_KEY_GRAVE_ACCENT: return KeyCode::Null;
                case GLFW_KEY_WORLD_1: return KeyCode::Null;
                case GLFW_KEY_WORLD_2: return KeyCode::Null;
        ...
        static MouseCode MapMouseButton(int glfwButton)
        {
            switch (glfwButton)
            {
                ...
                case GLFW_MOUSE_BUTTON_4: return MouseCode::ButtonSide;
                case GLFW_MOUSE_BUTTON_5: return MouseCode::ButtonExtra;
                case GLFW_MOUSE_BUTTON_6: return MouseCode::ButtonForward;
                case GLFW_MOUSE_BUTTON_7: return MouseCode::ButtonBack;
                default: return MouseCode::ButtonLeft;
            }
        }
    };
}
