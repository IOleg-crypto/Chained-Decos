...
namespace Chained
{
	...
	void UIFactory::Initialize()
	{
		std::call_once(s_UIFactoryInitFlag, []() {
			...
			Register("InputText",
					 [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = InputTextData{}; });
			...
			Register("Separator",
					 [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = SeparatorData{}; });
			...
			Register("DragFloat",
					 [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = DragFloatData{}; });
