...
void UIFactory::Initialize()
{
    ...
    Register("ProgressBar", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = ProgressBarData{}; });
    Register("Image", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = ImageData{}; });
    Register("ImageButton", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = ImageButtonData{}; });
    Register("Separator", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = SeparatorData{}; });
    Register("RadioButton", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = RadioButtonData{}; });
    Register("ColorPicker", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = ColorPickerData{}; });
    ...
    Register("CollapsingHeader", [](Entity e) { e.AddOrReplaceComponent<UIControlComponent>().Data = CollapsingHeaderData{}; });
