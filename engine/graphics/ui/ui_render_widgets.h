...
namespace Chained
{
	...
	bool RenderImageButton(ImageButtonData& imgBtn, UIControlComponent& wc, const ImVec2& pos, const ImVec2& size,
						   ImFont* font, const TextStyle& textStyle);
	...
	bool RenderCollapsingHeader(CollapsingHeaderData& header, UIControlComponent& wc, const ImVec2& pos,
								const ImVec2& size);
