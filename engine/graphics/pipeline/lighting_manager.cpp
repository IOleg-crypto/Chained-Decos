...
LightingManager::LightingManager(LightingData& lighting, ShadowState& shadow)
    : m_Lighting(lighting), m_Shadow(shadow)
{
}
...
void LightingManager::UploadLights()
{
...
void LightingManager::SetShadowState(bool enabled, uint32_t mapTextureID, const glm::mat4& lightSpaceMatrix, float bias)
{
...
void LightingManager::SetLightingUniforms(ShaderAsset* shaderAsset, const FrameState& frame)
{
