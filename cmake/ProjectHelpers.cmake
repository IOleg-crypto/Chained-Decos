    ...
    if(CSHARP_PROJECT_PATH)
        ...
        if(NOT TARGET ${SCRIPT_TARGET})
            ...
            add_custom_target(${SCRIPT_TARGET} ALL
                COMMAND dotnet build "${FULL_CSPROJ_PATH}" -c $<IF:$<OR:$<CONFIG:Debug>,$<CONFIG:>>,Debug,Release> --output "${CMAKE_CURRENT_SOURCE_DIR}/scripts/bin" --no-restore -p:CoralManagedDir="${CORAL_MANAGED_DIR}"
                WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
                COMMENT "Building C# Scripts for ${TARGET_NAME} (using cached packages)"
            )
