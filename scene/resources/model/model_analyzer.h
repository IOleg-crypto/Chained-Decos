#ifndef CD_SCENE_RESOURCES_MODEL_MODEL_ANALYZER_H
#define CD_SCENE_RESOURCES_MODEL_MODEL_ANALYZER_H
...
private:
     ...
     */
    static void AnalyzeEditorFormat(const std::string &content,
     ...
     * @param requiredModels Output vector to append required models to
     */
    static void AnalyzeGameFormat(const std::string &content,
                                  std::vector<std::string> &requiredModels);
...
#endif // CD_SCENE_RESOURCES_MODEL_MODEL_ANALYZER_H
