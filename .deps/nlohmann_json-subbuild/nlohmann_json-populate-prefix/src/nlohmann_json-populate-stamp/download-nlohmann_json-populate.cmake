...
if(EXISTS "D:/gitnext/Chained Decos/.deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/v3.12.0.zip")
...
foreach(i RANGE ${retry_number})
  ...
  foreach(url IN ITEMS [====[https://github.com/nlohmann/json/archive/refs/tags/v3.12.0.zip]====])
    if(NOT url IN_LIST skip_url_list)
      ...
      file(
        DOWNLOAD
        "${url}" "D:/gitnext/Chained Decos/.deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/v3.12.0.zip"
        SHOW_PROGRESS
        # no TIMEOUT
