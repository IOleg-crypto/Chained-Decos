...
void PlayerInput::ProcessInput()
{
    ...
    // This ensures input works immediately after closing menu even if ImGui state hasn't fully
    // reset
...
void PlayerInput::HandleJumpInput() const
{
    ...
    if (IsKeyPressed(KEY_SPACE))
    {
        ...
        CD_TRACE("PlayerInput::HandleJumpInput() - Jump key pressed, impulse: %.2f", jumpImpulse);
    }
}
